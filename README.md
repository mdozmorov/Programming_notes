...
- [batch-samples](https://github.com/GoogleCloudPlatform/batch-samples) - step-by-step tutorials and code samples to learn how to use [Batch](https://cloud.google.com/batch) on Google Cloud. [NIH Cloud Lab](https://cloud.nih.gov/resources/cloudlab/)
...
- [NIHCloudLabGCP](https://github.com/STRIDES/NIHCloudLabGCP) - Documentation and tutorials on using GCP for biomedical research
